...
The \texttt{amsmath} package.
Version 2.16a. Nov. 2016. \textsc{url}: \url{http://mirrors.ctan.org/macros/latex/required/amsmath/amsmath.pdf}.
\end{itemize}
%\printbibliography[keyword=manualexample1,heading=noheader]\nocite{Mittelbach2016}
%
...
dieser Vorlage \emph{nicht} mehr verwendet, sondern durch \texttt{biblatex} \cite{Lehman2016} ersetzt.
