...
%
\begin{itemize}
\item \emph{\textrm{\LaTeXe}-Kurzbeschreibung} von \textcite{Daniel2016}
\item \emph{The Not So Short Introduction to \textrm{\LaTeXe}} von \textcite{Oetiker2015}
\end{itemize}
%
\noindent
...
%
\begin{itemize}
  \item \emph{A Guide to \textrm{\LaTeX}} von \textcite{Kopka2003}
\end{itemize}
%
...
\emph{Comprehensive List of \textrm{\latex} Symbols} \parencite{Pakin2017}
und die Beschreibungen wichtiger \latex-Pakete, wie
%
\begin{quote}
  \texttt{babel} \parencite{Bezos2016},\newline
% \texttt{german}, \texttt{ngerman} \parencite{Raichle1998},\newline
  \texttt{grahics}, \texttt{graphicx} \parencite{Carlisle2016},\newline
  \texttt{fancyhdr} \parencite{Oostrum2016},\newline
  \texttt{caption} \parencite{Sommerfeldt2011},\newline
\end{quote}
...
\section{Das \texttt{hagenberg}-Paket}
