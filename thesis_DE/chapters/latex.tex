...
%%% Move to wiki
% Reason: These things frequently change and have no effect on content whatsoever
...
%%% Move to wiki
% Reason: This should go on a wiki page or in README.md. Don't think it's necessary in here.
% Discussion: Maybe we don't remove all of it but keep a few important aspects?
...
%%% Move to wiki
% Reason: Not fully sure about this section though...
