...
\caption{Coca-Cola Werbung 1940 \parencite{CocaCola1940}.}
\label{fig:CocaCola}
\end{figure}
...
\texttt{graphicx} \parencite{Carlisle2016} empfohlen 
...
\verb!\parencite{..}! zitiert werden, wie in Abb.\ \ref{fig:Bearings} demonstriert. 
...
Bildquelle~\parencite{Faires1934}.}
\label{fig:Bearings}
\end{figure}
