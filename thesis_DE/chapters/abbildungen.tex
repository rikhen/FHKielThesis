...
%%% Move to wiki
% Reason: These two subsections contain things that relate to the template, therefore wiki
...
%%% Move to wiki
% Reason: No offense, I know this is brand new but I think this is a special case that not everyone might need.
...
%%% Move to wiki
% Reason: It's also a special case
% Discussion: If we keep the Inkscape example, shouldn't this go in here as well?
...
%%% Maybe move the code environments to the wiki as well?
